      ...
      if(errorArray.length >= 2) {
        if(errorArray[0] === 'Error') {
          ...
          if(errorValue.substring(0,4) == 'ORA-') {
            ...
            customError.reason = customMessage || 'Oracle Error: ' + errorValue;
          } else {
            customError.reason = 'Oracle Error ' + errorValue;
          }
          customError.details = errorValue;
        }
      }
